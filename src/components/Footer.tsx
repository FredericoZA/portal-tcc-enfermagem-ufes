  ...
  return <footer id="home-page-footer-notes" className="space-y-2 pt-2 pb-3 border-t border-slate-200 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 relative">
    ...
    <div className="overflow-hidden rounded-lg border text-[11px]" style={{backgroundColor:footerBg,color:footerText,borderColor:footerBorder}}>
      <div className="grid md:grid-cols-[1fr_1.25fr] items-stretch">
        ...
        <div className="flex items-center justify-center p-2 min-h-[170px]">
          <div className="flex w-full max-w-[560px] items-center justify-center gap-2 sm:gap-3">
            ...
            {qrCodeSource&&<div className="w-[150px] h-[150px] sm:w-[180px] sm:h-[180px] shrink-0 overflow-hidden"><img src={qrCodeSource} alt="QR Code para contato pelo WhatsApp" className="block h-full w-full object-contain" referrerPolicy="no-referrer"/></div>}
          </div>
        </div>
      </div>
    </div>
