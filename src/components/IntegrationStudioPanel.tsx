          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 xl:grid-cols-[.75fr_1.25fr]">
              ...
              {selectedVariable && variableDraft && <div className={`${panelClass} space-y-4 p-4`}>
                <div className="flex items-center justify-between"><div className="flex items-center gap-2"><Variable className="h-4 w-4 text-violet-700" /><h4 className="text-xs font-black uppercase">Definição da variável</h4></div><button type="button" onClick={deleteSelectedVariable} aria-label="Excluir variável selecionada" className="rounded-lg border border-rose-200 bg-rose-50 p-2 text-rose-700"><Trash2 className="h-3.5 w-3.5" /></button></div>
                <div className="grid gap-3 sm:grid-cols-2">
