...
const MetricCard: React.FC<{
  ...
  <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
    <div className="flex items-start justify-between gap-3">
      ...
      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-50 text-[#5b635e]">
...
export const IndicadoresPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-[#344125]/20 bg-gradient-to-br from-[#5b635e] to-[#344125] p-5 text-white shadow-lg sm:p-7">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.18em] text-[#e5e7eb]">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[#f8fafc]">
          ...
          <button
            ...
            onClick={() => void load()}
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-xs font-black uppercase tracking-wide text-[#48504c] shadow-sm hover:bg-[#f8fafc] disabled:opacity-60"
          >
                  ...
                  return (
                    <div key={status} className="rounded-xl border border-slate-200 p-3">
                      ...
                      <div className="mt-2 h-2 overflow-hidden rounded-full bg-slate-100">
                        <div className="h-full rounded-full bg-[#5b635e]" style={{ width: `${percent}%` }} />
                      </div>
                    </div>
                  );
