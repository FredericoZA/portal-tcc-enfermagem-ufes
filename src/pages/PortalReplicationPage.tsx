  ...
  return (
    <div id="portal-replication-page" className="portal-public-shell mx-auto max-w-none overflow-hidden rounded-2xl border border-slate-300 bg-[#e1e6e9] shadow-sm">
      ...
      <section className="portal-layer-panel bg-[#e1e6e9] p-3 sm:p-4">
        ...
        <p className="mt-1 max-w-5xl text-xs leading-5 text-slate-600">O Portal combina serviços diferentes, cada um com uma função clara. Quem quiser reaproveitar a plataforma pode manter essa arquitetura ou substituir componentes equivalentes conforme a realidade da nova implantação.</p>
